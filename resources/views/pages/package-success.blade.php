...
<section class="page-hero">
    <div class="container-sm">
        ...
        <p>Your {{ $package->displayName() }} checkout{{ $sessionId ? ' (session ' . $sessionId . ')' : '' }} is complete. GoHighLevel will handle the setup automatically, so you can continue with your normal access flow.</p>
