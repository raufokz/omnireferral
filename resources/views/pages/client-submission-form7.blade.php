    ...
    <div class="client-submission-page">
        <section class="page-hero client-submission-hero">
            <div class="container-sm">
                ...
                <p>Finish this form so OmniReferral can finalize your setup and route you to the right dashboard workflow.
                </p>
            </div>
        </section>
            ...
            <div class="client-submission-shell">
                <article class="card-panel client-submission-card">
                    ...
                    <div class="client-submission-form-wrap">
                        <iframe src="{{ $onboardingFormSrc }}" style="width:100%;height:100%;border:none;border-radius:3px"
                            id="inline-K1yKrK1hQrLDUM2Sz0Tz" data-layout="{'id':'INLINE'}" data-trigger-type="alwaysShow"
                            data-trigger-value="" data-activation-type="alwaysActivated" data-activation-value=""
                            data-deactivation-type="neverDeactivate" data-deactivation-value=""
                            data-form-name="Onboarding Form" data-height="2867"
                            data-layout-iframe-id="inline-K1yKrK1hQrLDUM2Sz0Tz" data-form-id="K1yKrK1hQrLDUM2Sz0Tz"
                            title="Onboarding Form" loading="lazy">
                        </iframe>
                    </div>
