    ...
    public function run(): void
    {
        ...
        $packages = collect([
            ...
            [
                ...
                'description' => 'A dedicated ISA Sales Agent providing data scraping, daily scheduling, CRM setup, and multi-channel follow-ups for consistent top-of-funnel growth.',
            ...
            [
                ...
                'description' => 'Daily long and short form video content, audience engagement management, custom ads, and brand development across IG, FB, LinkedIn, and TikTok.',
                'category' => 'virtual_assistant',
                'billing_type' => 'monthly',
                'is_featured' => true,
                'is_active' => true,
            ...
            [
                'name' => 'Individual VA',
                'slug' => 'individual-va',
                'description' => 'Flexible hourly virtual assistant support for appointment setting, CRM management, graphic design, data entry, and custom automation workflows.',
                'category' => 'virtual_assistant',
                'billing_type' => 'hourly',
                'is_featured' => false,
                'is_active' => true,
        ...
        foreach ([
            ...
            ['Natalie Stone', 'agent', 'Best American Homes', 'Tampa, FL', 'Power Leads gave us the right balance of urgency and detail. It feels far more organized than the other lead sources we tested.', false, 'images/companies-logos/best-american-homes-150x150.jpg'],
